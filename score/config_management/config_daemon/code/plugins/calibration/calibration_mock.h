...
// *******************************************************************************
#ifndef SCORE_CONFIG_MANAGEMENT_CONFIG_DAEMON_CODE_PLUGINS_CALIBRATION_CALIBRATION_MOCK_H
#define SCORE_CONFIG_MANAGEMENT_CONFIG_DAEMON_CODE_PLUGINS_CALIBRATION_CALIBRATION_MOCK_H
...
class CalibrationMock final : public IPlugin
{
  public:
    CalibrationMock() = default;
    ~CalibrationMock() override = default;
    ...
    MOCK_METHOD(std::int32_t,
                Run,
                (std::shared_ptr<data_model::IParameterSetCollectionManager> parameterset_collection,
...
#endif  // SCORE_CONFIG_MANAGEMENT_CONFIG_DAEMON_CODE_PLUGINS_CALIBRATION_CALIBRATION_MOCK_H
